...
def step(costs, resources=(0, 0, 0), dr=(1, 0, 0), timeleft=21):
...
for bp in inp.split("\n"):
    ...
    # arr=[]
    # for i in range(1,25):
    #     arr.append([(k,v) for (k,v) in MEMO.items() if k[-1]==i])
    # arr2=arr.copy()
    # for ar in arr:
    #     a=ar.copy()
    #     for k1,v1 in a:
    ...
    #             if k1!=k2:
    #                 if k1[0]==k2[0]:
    #                     if k2[1][0]>=k1[1][0] and k2[1][1]>=k1[1][1] and k2[1][2]>=k1[1][2] and v2>=v1:
    #                         if (k1,v1) in ar:
    #                             ar.remove((k1,v1))
